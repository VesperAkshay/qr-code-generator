...
import { FaQrcode, FaUser, FaChartLine, FaCog, FaLifeRing, FaSignOutAlt, FaImage, FaShareAlt, FaBoxes, FaFilePdf } from 'react-icons/fa';
    ...
    <div className={`min-h-screen bg-gradient-to-r p-8 ${darkMode ? 'bg-gradient-to-r from-[#192646] to-[#00050e]' : 'bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500'}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          { to: "/qr-scanner", icon: <FaQrcode />, title: "QR Code Scanner", description: "Scan and decode QR codes.", color: "text-white", bgColor: "bg-orange-600" },
          { to: "/pdf-qr-code", icon: <FaFilePdf />, title: "PDF to QR", description: "Convert PDFs to QR codes.", color: "text-white", bgColor: "bg-red-600" },
          ...
          >
            <Link href={to} className="text-center flex flex-col items-center">
