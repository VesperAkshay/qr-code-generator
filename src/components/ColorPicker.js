    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 p-4 bg-white dark:bg-[#2b2661] rounded-xl shadow-lg">
      ...
      <div>
        ...
        <motion.input
          ...
          className="w-full h-12 p-2 border border-gray-300 rounded-lg cursor-pointer transition-colors focus:ring-2 focus:ring-indigo-500 dark:bg-indigo-950 dark:border-gray-900"
